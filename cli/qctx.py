...
def output(obj, as_json: bool) -> None:
    if as_json:
...
# Prefixes of collections generated by another system. With 84 collections in Qdrant,
# a raw listing drowns what matters — and choosing an archive is precisely the
# operation where a person needs to SEE the options. Hidden by default, `--all` shows.
NOISE = ("ws-",)
